...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/seamm-datastore-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14610&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/seamm-datastore-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `seamm-datastore` can be installed with:

```
conda install seamm-datastore
```

It is possible to list all of the versions of `seamm-datastore` available on your platform with:
